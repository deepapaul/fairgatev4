...
class FgCmsMapElement {
    
    
    elementLogDetailsPath :any='';
    elementId  :any = '';
    ...
    public isValidForm(data, location, mapHeight) {
    ...
    public saveMap(data, validLocation) {
        var validation = 1;
