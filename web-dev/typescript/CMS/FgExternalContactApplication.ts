...
class FgExternalContactApp {
    ...
    public renderApplicationForm(data) {
    ...
    public handleFormFields(data){
            ...
            public handleFormFileUpload(elementId) {
            ...
            public handleTimePicker(elementId) {
                var timeFormatData = {};
