...
//            success: function(data) {
    ...
    public saveCallBack(isGuestContact, guestContactName, postContent, data) {
    ...
    public createCommentHtml(isGuestContact, guestContactName, postContent, data) {
        var commentHtml = '';
...
//        '<div class="fg-profile-img-blk45 fg-round-img" style="background-image:url("'+ contactImage +'")"></div>'
    ...
    public getArticleTitle(articleData){
        var title = '';
