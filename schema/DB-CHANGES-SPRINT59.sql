...
('gotcourts', 'gotcourts', 'gotcourts', 'gotcourts', 'gotcourts@yopmail.com', 'gotcourts@yopmail.com', 'sha1', '', 'Kaz/8MTGYDPwLDxx1529Rij8ICql5YLXmRscOzvZuIIIdIkOUypiTUU5eslrDqnl1sZWRQoM/sbkmim0zHMcZw==', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 427653, NULL, 0, 0, 0, 0, NULL, 1, '', 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:10:"ROLE_SUPER";}', 0, NULL, 1, 'Z3lTaGtJSE9MN1lSZDJjbDRuZlY5bzl0NnE4QmxxU0JDRFRKZWVLQmM5RnMwRCtwejdJNHBMalA0RDZMOXdxdFVmcEI4UEdpVHFKUS9xOWtTSFNVTkE9PQ==');


INSERT INTO `sf_guard_user_group` (`user_id`, `group_id`, `created_at`, `updated_at`) VALUES
(330946 , 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');


/website/cms/resavejson/allpage


UPDATE `fg_tm_theme_color_scheme` SET `css_filename` = NULL WHERE `theme_id` = 2
-- // PLEASE clear apc cache, when updating this query