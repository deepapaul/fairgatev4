...
DROP TABLE `fg_mb_module`,`fg_mb_club_modules`;
DROP TABLE `fg_categorisation`, `fg_subcategorisation`, `fg_subsubcategorisation`;

DROP TABLE `fg_club_bookmarks`,`fg_club_filter`, `fg_club_table_settings`;
DROP TABLE `fg_club_log`;
DROP TABLE `fg_club_address`;


DROP TABLE `fg_club_class_log`,`fg_club_class_assignment`,`fg_club_class_i18n`,`fg_club_class`; 
DROP TABLE`fg_club_classification_i18n`,`fg_club_classification`;


ALTER TABLE `fg_club` DROP `has_promobox`;
ALTER TABLE `fg_club` DROP `fed_admin_access`;
ALTER TABLE `fg_club` DROP `add_existing_fed_member_club`;
ALTER TABLE `fg_club` DROP `fed_membership_mandatory`;
ALTER TABLE `fg_club` DROP `club_membership_available`;
ALTER TABLE `fg_club` DROP `club_number`;
ALTER TABLE `fg_club` DROP `clientstatecheck`;
ALTER TABLE `fg_club` DROP `is_fg_newsletter_subscriber`;
ALTER TABLE `fg_club` DROP `diskspace_amount`;
ALTER TABLE `fg_club` DROP `disk_space`;
ALTER TABLE `fg_club` DROP `clientstate_amount`;
ALTER TABLE `fg_club` DROP `dun_dispatch_type`;
ALTER TABLE `fg_club` DROP `invoice_dispatch_type`;
ALTER TABLE `fg_club` DROP `state`;
ALTER TABLE `fg_club` DROP `okk`;
ALTER TABLE `fg_club` DROP `newsletter_powered`;
ALTER TABLE `fg_club` DROP `is_sbo`;
ALTER TABLE `fg_club` DROP `created_at`;
ALTER TABLE `fg_club` DROP `backend_lang`;
ALTER TABLE `fg_club` DROP `hear_about_fairgate`;
ALTER TABLE `fg_club` DROP `access_updated_on`;
ALTER TABLE `fg_club` DROP `is_backend_access`;
ALTER TABLE `fg_club` DROP `next_renewal_date`;
ALTER TABLE `fg_club` DROP `invoice_date`;
ALTER TABLE `fg_club` DROP `last_updated`;
ALTER TABLE `fg_club` DROP `first_contact_type_id`;
ALTER TABLE `fg_club` DROP `next_contact_date`;
ALTER TABLE `fg_club` DROP `website`;
ALTER TABLE `fg_club` DROP `email`;
ALTER TABLE `fg_club` DROP `is_visible`;
ALTER TABLE `fg_club` DROP `is_active`;
ALTER TABLE `fg_club` DROP `year`;
ALTER TABLE `fg_club` DROP `is_registered`;
ALTER TABLE `fg_club` DROP `is_fairgate`;

ALTER TABLE `fg_club` DROP `responsible_contact_id`;

ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_26;
ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_24;
ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_23;
ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_22;
ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_21;
ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_20;
ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_2;
ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_19;
ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_18;
ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_17;
ALTER TABLE fg_club DROP FOREIGN KEY fg_club_ibfk_1;


ALTER TABLE `fg_club` DROP `created_by`;
ALTER TABLE `fg_club` DROP `access_updated_by`;
ALTER TABLE `fg_club` DROP `assignment_subactivity`;
ALTER TABLE `fg_club` DROP `assignment_activity`;
ALTER TABLE `fg_club` DROP `assignment_state`;
ALTER TABLE `fg_club` DROP `assignment_country`;
ALTER TABLE `fg_club` DROP `fairgate_invoice_contact`;
ALTER TABLE `fg_club` DROP `fairgate_sponsor_contact`;
ALTER TABLE `fg_club` DROP `fairgate_solution_contact`;
ALTER TABLE `fg_club` DROP `billing_id`;
ALTER TABLE `fg_club` DROP `correspondence_id`;



-- article elelement v2
ALTER TABLE `fg_cms_page_content_element` 
    ADD `article_display_type` ENUM('slider','listing') NOT NULL DEFAULT 'listing' AFTER `twitter_content_height`, 
    ADD `article_count` INT(5) NOT NULL DEFAULT '5' COMMENT 'Number of articles per row for article_display_type ''listing'' and Number of articles for article_display_type ''slider''' AFTER `article_display_type`, 
    ADD `article_slider_navigation` ENUM('none','right','bottom') NOT NULL DEFAULT 'none' AFTER `article_count`, 
    ADD `article_show_thumb_img` TINYINT NOT NULL DEFAULT '0' AFTER `article_slider_navigation`, 
    ADD `article_show_date` TINYINT NOT NULL DEFAULT '0' AFTER `article_show_thumb_img`, 
    ADD `article_show_category` TINYINT NOT NULL DEFAULT '0' AFTER `article_show_date`, 
    ADD `article_show_area` TINYINT NOT NULL DEFAULT '0' AFTER `article_show_category`, 
    ADD `article_rows_count` INT(3) NOT NULL DEFAULT '4' COMMENT 'Number of rows for article_display_type ''listing''' AFTER `article_show_area`;

ALTER TABLE `fg_cms_page_content_element` CHANGE `article_count` `article_count` INT(5) NOT NULL DEFAULT '5' COMMENT 'Number of articles for article_display_type ''slider''';

ALTER TABLE `fg_cms_page_content_element` ADD `article_per_row` INT(2) NOT NULL DEFAULT '1' COMMENT 'Number of articles per row for article_display_type ''listing''' AFTER `article_display_type`;

/******************  ARCHIVE PROCEDURE CHANGE --------------------*/
...
---FAIRDEV-361 - Confirmation and login handling of self registered clubs 
update `fg_club` set `status` = 'Active'  WHERE 1
---------------------------------
