 ...
 *
 */
class ForumlistingTest extends WebTestCase {
    ...
    */
    public function testteamforumlist()
    {
       $crawler = $this->client->request('GET', '/team/forum');
       $this->assertEquals(0, $crawler->filter('.DTFC_LeftWrapper')->count());
    }
    public function testworkgroupforumlist()
    {
       $crawler = $this->client->request('GET', '/workgroup/forum');
       $this->assertEquals(0, $crawler->filter('.DTFC_LeftWrapper')->count());
    }
