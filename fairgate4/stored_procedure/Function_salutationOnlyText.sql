DROP FUNCTION IF EXISTS `salutationOnlyText`//
CREATE FUNCTION `salutationOnlyText`(contactId INT, clubId INT, clubSystemLang CHAR(2), culture CHAR(2)) RETURNS text
BEGIN
	
	DECLARE salutation, firstName, lastName, gender, corrresLang, companyName, contactTitle TEXT DEFAULT ''; 
