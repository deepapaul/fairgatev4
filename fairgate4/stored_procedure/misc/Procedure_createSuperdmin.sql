...
CREATE PROCEDURE `createSuperdmin`(admin_first_name VARCHAR(50), admin_last_name VARCHAR(50), admin_email VARCHAR(255), admin_username VARCHAR(255), admin_company_name VARCHAR(255), isCompany INT(1))
BEGIN
	...
	START TRANSACTION;
            ...
            (admin_first_name, admin_last_name, admin_username, admin_username, admin_email, admin_email, 'sha1', '', '', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', new_contact_id, 0, 1, '', 0, 0, NULL, NULL, 'a:1:{i:0;s:10:"ROLE_SUPER";}', 0, 1);
