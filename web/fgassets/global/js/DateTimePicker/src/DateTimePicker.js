...
}(function ($) 
{
	...
	DateTimePicker.prototype = {
		...
		_setTimeFormatArray: function()
		{
			...
			oDTP.oData.sArrInputTimeFormats.push(sTime);
                    //    console.log(oDTP.oData.sArrInputTimeFormats);
		},
		...
		_matchFormat: function(sMode, sFormat)
		{
			...
			{
                             //   console.log(oDTP.oData.bArrMatchFormat);
                        //console.log(sFormat);
                        //console.log($.cf._compare(sFormat, oArrInput[iTempIndex]));
