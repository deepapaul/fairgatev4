var saveRedirectBck = false;
var globalFormId;
var FgTextElement = (function () {
    function FgTextElement() {
    }
    FgTextElement.prototype.renderContent = function () {
    ...
    FgTextElement.prototype.renderLog = function () {
    ...
    FgTextElement.prototype.redirectBack = function () {
        $('#reset_changes').on('click', function () {
            window.location = editpageUrl;
        });
    };
    FgTextElement.prototype.setErrorMessage = function (uploadObj, data) {
    ...
    ;
    FgTextElement.prototype.handleDeleteIconColor = function () {
    ...
    FgTextElement.prototype.handleDeleteNewRow = function () {
        $('body').on('click', '.fg-delete-img', function (e) {
            $(this).parents('.fileimgcontent').remove();
        });
    };
    FgTextElement.prototype.toggleTextElementTabs = function () {
        var _this = this;
    ...
    FgTextElement.prototype.updateRevisionText = function () {
        var _this = this;
    ...
    FgTextElement.prototype.renderTextElementHistory = function () {
        var _this = this;
    ...
    FgTextElement.prototype.handleSave = function () {
        var _this = this;
    ...
    FgTextElement.prototype.displayError = function (lang) {
    ...
    FgTextElement.prototype.handleLangSwitch = function () {
        _.each(clubLanguages, function (lang, key) {
            if ($('#articleTextValidation-' + lang).val() == '') {
                $('#' + lang).addClass('error');
            }
    ...
    FgTextElement.prototype.handleGalleryBrowser = function () {
        FgGalleryBrowser.initialize(galleryBrowserSettings);
        FgGalleryBrowser.setSortable($('.fg-files-uploaded-lists-wrapper'));
    };
    FgTextElement.prototype.checkMediaDescriptionChange = function () {
    ...
    FgTextElement.prototype.handleVideoUrls = function () {
        var _this = this;
    ...
    FgTextElement.prototype.changeVideoUrlCallBack = function (settings) {
    ...
    FgTextElement.prototype.handleTitleBar = function (langSwitch) {
    ...
    FgTextElement.prototype.CkEditorConfig = function (clubLanguages) {
    ...
    ;
    FgTextElement.prototype.renderTemplate = function (templateId, pathTemplateTextElementJson, pathTextElementSave, formId) {
        globalFormId = formId;
    ...
    FgTextElement.prototype.successCallBack = function () {
        if (saveRedirectBck) {
            window.location = editpageUrl;
        }
    };
    FgTextElement.prototype.discardChangesCallbackFn = function () {
    ...
    FgTextElement.prototype.handleFormElements = function () {
        if (mode == "create") {
    ...
    FgTextElement.prototype.dirtyfieldChangeCallBk = function (originalValue, isDirty) {
        if ($(this).hasClass('media-desc') && (isDirty)) {
            $(this).parent('.fg-media-desc').find('.fg-media-desc-hid').addClass('fairgatedirty');
        }
    };
    FgTextElement.prototype.addVideoTemplate = function () {
        var timestamp = $.now();
...
var ImagesUploader = (function () {
    ...
    ImagesUploader.prototype.addImgCallback = function () {
        FgDirtyFields.updateFormState();
    };
    return ImagesUploader;
}());
var FgCmsTextElementLog = (function () {
    function FgCmsTextElementLog() {
    }
    FgCmsTextElementLog.prototype.init = function () {
        this.dataTableOpt();
        FgDatatable.listdataTableInit('datatable-element-log-list', datatableOptions);
    };
    FgCmsTextElementLog.prototype.reload = function () {
        listTable.ajax.reload();
    };
    FgCmsTextElementLog.prototype.dataTableOpt = function () {
        var columnDefs = [];
