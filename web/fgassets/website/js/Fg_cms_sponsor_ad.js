var FgCmsSponsorAdElement = (function () {
    function FgCmsSponsorAdElement() {
    }
    FgCmsSponsorAdElement.prototype.validateForm = function () {
    ...
    FgCmsSponsorAdElement.prototype.renderContent = function () {
    ...
    FgCmsSponsorAdElement.prototype.renderLog = function () {
    ...
    FgCmsSponsorAdElement.prototype.saveElementCallback = function (d) {
    ...
    FgCmsSponsorAdElement.prototype.discardChangesCallback = function () {
    ...
    FgCmsSponsorAdElement.prototype.discardAfterSave = function () {
    ...
    return FgCmsSponsorAdElement;
}());
var FgCmsSponsorElementLog = (function () {
    function FgCmsSponsorElementLog() {
    }
    FgCmsSponsorElementLog.prototype.init = function () {
        this.dataTableOpt();
        FgDatatable.listdataTableInit('datatable-element-log-list', datatableOptions);
    };
    FgCmsSponsorElementLog.prototype.dataTableOpt = function () {
        var columnDefs = [];
