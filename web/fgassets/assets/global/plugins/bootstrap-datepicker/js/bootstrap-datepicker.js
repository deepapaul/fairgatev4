      ...
      var element = this.component ? this.element.find('input') : this.element;
		...
		place: function(){
			...
			this.picker.addClass('datepicker-orient-' + yorient);
                        ...
                        //Date picker alignment issue on both internal and backend due to page container margin
                        //Patches
                         if(window.location.href.indexOf("backend") > -1) { // check internal or backend 
                            if (yorient === 'top'){
