FgDocumentColumnSettings = {
    ...
    displaySelectedColumns: function(id, typee, clubId, orgType) {
        ...
        if ((labelName != '') && (typeof labelName != 'undefined')) {
            ...
            FgDocumentColumnSettings.renderColumns('template-display-selectedcolumns', 'displaySelectedColumns', jsonData, true);
        }
    },
    ...
    applySettings: function(obj) {
        ...
        if (saveType == 'APPLY') {
            localStorage.setItem('documenttableSettingValue_' + type + clubId +'-' +contactId, settingsData);
    ...
    $(document).ready(function() {
        ...
        $.getJSON(filterDocData, function(data) {
            ...
            var fileOptions = (typeof(jsonData.FILE) == "undefined")? null:jsonData.FILE;
                ...
                FgDocumentColumnSettings.renderColumns('template-display-file-options', 'displayFileOptions', fileData);
            ...
            var DateOptions = (typeof(jsonData.DATE) == "undefined")? null: jsonData.DATE;
                ...
                FgDocumentColumnSettings.renderColumns('template-display-date-options', 'displayDateOptions', dateData);
            ...
            var UserOptions = (typeof(jsonData.USER) == "undefined")? null:jsonData.USER;
                ...
                FgDocumentColumnSettings.renderColumns('template-display-user-options', 'displayUserOptions', userData);

            var selectedSettings = localStorage.getItem('documenttableSettingValue_' + type + clubId +'-' +contactId) ? localStorage.getItem('documenttableSettingValue_' + type + clubId +'-' +contactId) : defaultSettingsArray;
            ...
            $.each(selectedSettings, function(sortOrder, selectedSetting) {
                ...
                FgDocumentColumnSettings.displaySelectedColumns(selectedSetting.id, selectedSetting.type, settingClubId, orgType);
            });
            
        FgDocumentColumnSettings.initPageFunctions();   
        });
       ...
       //function to select item on click
        $('form').on('click', 'i.selectitem', function() {
            if (!($(this).hasClass('disabled') || $(this).parent().hasClass('disabled'))) {
                ...
                FgDocumentColumnSettings.displaySelectedColumns(this.id, selType, $(this).attr('club_id'), $(this).attr('type'));
                FgDragAndDrop.init('#displaySelectedColumns');
                $('.popovers').popover();
            }
        });
        ...
        $(document).on('click', '#applysettings', function() {
            FgDocumentColumnSettings.applySettings(this);
            return false;
        });
