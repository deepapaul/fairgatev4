var FgMoreMenu = function() {
    ...
    var handleMoreMenu = function(menuSelector) {
        ...
        if (mw < w) {
            ...
            if( $(menuSelector + ' > li.active.fg-truncate span').hasClass('badge-round') ||  $(menuSelector + ' > li.active.fg-truncate span').hasClass('fg-more-icons-nav') ){
                $(menuSelector + ' > li.active.fg-truncate').addClass('has-badge-no');
            }else{
                $(menuSelector + ' > li.active.fg-truncate').removeClass('has-badge-no');
            }
