FgExternalConfirmations = {
    ...
    initDatatable : function() {
        var options = FgExternalConfirmations.getInitialOpt('list');
        FgExternalConfirmations.confirmationsListTable = $('table#confirmations-list-table').DataTable(options);
        var options = FgExternalConfirmations.getInitialOpt('log');
        FgExternalConfirmations.confirmationsLogTable = $('table#confirmations-log-table').DataTable(options);
    }
}
$(document).ready(function() {
    
    FgExternalConfirmations.initDatatable();
