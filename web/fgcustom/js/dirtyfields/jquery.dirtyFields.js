(function($) {
	...
	$.fn.dirtyFields = function(parameters) {
		...
		return this.each(function() {
			...
			$("input[type='text'],input[type='url'],input[type='file'],input[type='password'],textarea",$container).not("." + $container.data("dF").exclusionClass).each(function(i) {
	...
	$.fn.dirtyFields.setStartingValues= function($container,opts) {
		$("input[type='text'],input[type='url'],input[type='file'],input[type='password'],:checkbox,:radio,textarea",$container).not("." + $container.data("dF").exclusionClass).each(function(i) {
				var $object= $(this);
