var FgDirtyFields = function() {
	...
	var defaultSettings = {
                ...
                unsavedAlertMessage		: datatabletranslations.dirtyformAlert, // unsaved data alert text
	...
	var bindFields = function($container){ 
			$("input[type='text'],input[type='email'],input[type='file'],input[type='password'],textarea",$container).not("." + $object.data("dF").exclusionClass).each(function(i) {
