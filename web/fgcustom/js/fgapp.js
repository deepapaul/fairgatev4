...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            $('#style_color').attr("href", "/backend/css/themes/" + color_ + ".css");
            if ($.cookie) {
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            var html = '';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src=".//backend/img/loading-spinner-grey.gif" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src=".//backend/img/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        startPageLoading: function(message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading"><img src="/fgcustom/img/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (message ? message : datatabletranslations.loadingVar) + '</span></div>');
        },
...
//        handleDragAndDrop(sortDiv, false);
//    },
//    initWithChild: function(sortDiv) {
//        handleDragAndDrop(sortDiv, true);
//    },
//    orderSort:function(sortDiv,inputId){
//        handleSortDragAndDrop(sortDiv, false, true, inputId)
//    }
//};
//
//var handleDragAndDrop = function(sortDiv, doChildSort) {
//    $(sortDiv).each(function() {
//        $(this).sortable({
//            droppable: true,
//            connectWith: $(this).children(),
//            items: $(this).children(),
//            opacity: 0.8,
...
//                    var dragPosition = ui.item.startPos;
//                    var dropPosition = ui.item.stopPos;
...
//    });
//}
//var handleSortDragAndDrop = function(sortDiv, doChildSort,sortCheck,inputId) {
//    $(sortDiv).each(function() {
//        $(this).sortable({
//            droppable: true,
//            connectWith: $(this).children(),
...
//               if(sortCheck){
//                   var changeval='';
//                $(".fairdragg div").each(function(index,value){
